...
module Game.Werewolf.Player (
    ...
    -- ** Traversals
    angel, defender, devotedServant, druid, jester, scapegoat, seer, simpleVillager, simpleWerewolf,
    ...
    angels, defenders, devotedServants, druids, jesters, scapegoats, seers, simpleVillagers,
